...
{
    [Injectable(InterfaceType = typeof(IBatchExtensions))]
    public class BatchExtensions : IBatchExtensions
    {
        //
        // Summary:
        ...
        {
            return EntityFramework.Extensions.BatchExtensions.Delete<T>(source);
        }
