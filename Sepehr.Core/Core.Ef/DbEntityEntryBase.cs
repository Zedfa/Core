...
namespace Core.Ef
{
    public class DbEntityEntryBase : IDbEntityEntryBase
    {
        System.Data.Entity.Infrastructure.DbEntityEntry _dbEntityEntry;

        public DbEntityEntryBase(System.Data.Entity.Infrastructure.DbEntityEntry entry)
        {
            _dbEntityEntry = entry;
        }
        public IDbPropertyValuesBase CurrentValues
        {
            get
            {
                return new DbPropertyValuesBase(_dbEntityEntry.CurrentValues);
            }
        }
        ...
        public IDbPropertyValuesBase OriginalValues
        {
            get
            {
                return new DbPropertyValuesBase(_dbEntityEntry.OriginalValues);
            }
        }
