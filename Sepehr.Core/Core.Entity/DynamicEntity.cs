...
namespace Tools.Cmn
{
    ...
    [Serializable]
    public class DynamicEntity : EntityBase<DynamicEntity>, IDynamicMetaObjectProvider
    {
        #region Dynamic
        ...
        protected override void OnColumnChanging(string columnName, ref object value)
        {
