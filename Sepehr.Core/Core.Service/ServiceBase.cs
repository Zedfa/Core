    ...
    public class ServiceBase<T> : ServiceBase, IServiceBase<T>, IServiceCache, IDisposable where T : EntityBase<T>, new()
    {
        ...
        public ReturnT Cache<ReturnT>(Func<ReturnT> func, bool canUseCacheIfPossible = true)
        {
            ...
            if (func != null)
            {
                ...
                {
                    ReturnT result = CacheBase.Cache<ReturnT>(queryableCacheExecution, cacheInfo, cacheInfo.ExpireCacheSecondTime, cacheKey, canUseCacheIfPossible);
                    return result;
                }
                else
                {
        ...
        public R Cache<P1, R>(Func<P1, R> func, P1 param1, bool canUseCacheIfPossible = true)
        {
            ...
            if (func != null)
            {
                ...
                if (canUseCacheIfPossible)
                {
                    ...
                    R result = CacheBase.Cache<R>(queryableCacheExecution, cacheInfo, cacheInfo.ExpireCacheSecondTime, cacheKey, canUseCacheIfPossible);
                    return result;
                }
                else
                {
