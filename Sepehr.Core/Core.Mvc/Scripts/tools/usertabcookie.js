var ns_Cookie;
(function (ns_Cookie) {
    function clearCookie(cookieUserName) {
        var cval = document.cookie;
    }
    ns_Cookie.clearCookie = clearCookie;
    function setTabsInLocalStorage(tabItems) {
    ...
    ns_Cookie.setTabsInLocalStorage = setTabsInLocalStorage;
