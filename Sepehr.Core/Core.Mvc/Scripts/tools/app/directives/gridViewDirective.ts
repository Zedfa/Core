    ...
    return {
        ...
        link: function (scope, elem, attrs) {
            ...
            gridObj.then(function (config) {
                ...
                config["editable"] = null; //{ mode: null, createAt: "bottom" };
                config["dataSource"]["transport"].cache = true;
                config["dataSource"]["transport"].read.cache = false;

                //config.dataSource.transport.parameterMap = function (a, b, c) {


                //}
                //config.dataSource.requestStart = function (args) {

                //};
                //config.dataSource.requestEnd = function (args) {
                //    debugger;

                //};
                //config.dataSource.sync = function (args) {
                //    debugger;

                //};
                //config.dataSource.change = function (args) {

                //   

                //};
                //config.excelExport = (args) => {
                ...
                config["dataBound"] = function (e) {
                    ...
                    //dar mavagheyi ke parent e gird hidden bashad vertical scroll ro harcheghadr ham update konim fayde nadare chon hidden hast ,
                    //bayad sabr konim ta zamani ke pedar e grid show shod 1bar scroll ro update konim
                    var parentCheckHiddenInterval = setInterval(() => {
            ...
            //scope.$on("kendoRendered", function (options, widget) {
            //    debugger;
            //});
        },
        template: "<div></div>"
