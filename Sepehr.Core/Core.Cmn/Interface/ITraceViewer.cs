...
namespace Core.Cmn
{
    ...
    {
        string Name { get; }
        void RequestStart(int RequestID, string Url, string traceKey = "");

        void RequestPhase(int RequestID, string PhaseName, string traceKey = "");

        void RequestStop(int RequestID, string traceKey = "");

        void DebugTrace(string Message, string traceKey = "", EventLogEntryType level = EventLogEntryType.Information);
    }
